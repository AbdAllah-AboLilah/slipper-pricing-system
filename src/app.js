...
function bindInvoice(d){
 ...
 document.getElementById('commitLine').onclick=()=>{const calc=calcLine(composeLine,state.settings,state.tiers,state.items);d.lines.push({...composeLine,id:uid('line')});composeLine=blankComposeLine(calc.type||d.type);scheduleAuto();render()};
